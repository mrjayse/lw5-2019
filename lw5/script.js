      ...
      if (payment.amount != 0) {
        ...
        switch (paymentType) {
          case "accrual":
            ...
            break;
          case "write-off":
            if ((this.amount + payment.amount) >= 0) {
              this.amount += payment.amount;
              console.log("Тип транзакции: Списание");
              console.log("Сумма списания: " + Math.abs(payment.amount));
              console.log("Комментарий: " + payment.info);
              console.log("Текущая сумма счета: " + this.amount);
            }
            else {
...
function replaceString(sourceString, oldString, newString) {
  ...
  !(typeof oldString == "string" || typeof oldString == "number") ||
  !(typeof newString == "string" || typeof newString == "number")) {
